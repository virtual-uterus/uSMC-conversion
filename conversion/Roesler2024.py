...
Roesler2024 cell model Python version
...
def create_legends():
    ...
    legend_algebraic[0] = "I_stim in component stimulus_protocol (uA_per_cm2)"
    ...
    legend_constants[3] = "stim_current in component stimulus_protocol (uA_per_cm2)"
    legend_algebraic[45] = "I_tot in component membrane (uA_per_cm2)"
    legend_algebraic[27] = "I_Ca_tot in component Ca_currents (uA_per_cm2)"
    legend_algebraic[43] = "I_NS_tot in component NS_currents (uA_per_cm2)"
    legend_algebraic[38] = "I_K_tot in component K_currents (uA_per_cm2)"
    legend_states[0] = "v in component membrane (mV)"
    legend_constants[4] = "Cm in component parameters (uF_per_cm2)"
    legend_algebraic[16] = "ina in component I_Na (uA_per_cm2)"
    legend_algebraic[28] = "ib in component I_b (uA_per_cm2)"
    legend_algebraic[39] = "icl in component I_Cl (uA_per_cm2)"
    ...
    legend_constants[8] = "E2_max in component membrane (nM_per_L)"
    legend_constants[25] = "mod_E2 in component membrane (dimensionless)"
    legend_constants[26] = "mod_P4 in component membrane (dimensionless)"
    ...
    legend_algebraic[42] = "insca in component I_NSCa (uA_per_cm2)"
    ...
    legend_constants[70] = "frdy in component parameters (coulomb_per_mole)"
    ...
    legend_constants[9] = "conversion in component Ca_Concentrations (mM_to_M)"
    legend_constants[56] = "ki in component parameters (mM)"
    legend_constants[57] = "nai in component parameters (mM)"
    legend_constants[60] = "cli in component parameters (mM)"
    legend_constants[61] = "ko in component parameters (mM)"
    legend_constants[27] = "cao in component parameters (mM)"
    legend_constants[62] = "nao in component parameters (mM)"
    legend_constants[64] = "clo in component parameters (mM)"
    legend_constants[28] = "mgo in component parameters (mM)"
    legend_constants[29] = "zna in component parameters (dimensionless)"
    ...
    legend_constants[10] = "gna in component parameters (mS_per_cm2)"
    legend_constants[11] = "gcal in component parameters (mS_per_cm2)"
    legend_constants[31] = "ecal in component parameters (mV)"
    legend_constants[32] = "kmca in component parameters (mM)"
    legend_constants[12] = "gcat in component parameters (mS_per_cm2)"
    legend_constants[33] = "ecat in component parameters (mV)"
    legend_constants[13] = "gkca in component parameters (mS_per_cm2)"
    legend_constants[14] = "gb in component parameters (mS_per_cm2)"
    legend_constants[15] = "gkv43 in component parameters (mS_per_cm2)"
    ...
    legend_constants[18] = "gcl in component parameters (mS_per_cm2)"
    legend_constants[19] = "gns in component parameters (mS_per_cm2)"
    ...
    legend_constants[37] = "PnsCs in component parameters (dimensionless)"
    legend_constants[38] = "gnsCa in component parameters (dimensionless)"
    legend_constants[39] = "gnsNa in component parameters (dimensionless)"
    legend_constants[40] = "gnsK in component parameters (dimensionless)"
    legend_constants[41] = "gnsCs in component parameters (dimensionless)"
    legend_constants[42] = "PK in component parameters (dimensionless)"
    legend_constants[43] = "PNa in component parameters (dimensionless)"
    ...
    legend_constants[72] = "Jnaca in component parameters (mM_per_msec)"
    legend_constants[47] = "Kmallo in component parameters (mM)"
    legend_constants[48] = "nallo in component parameters (dimensionless)"
    legend_constants[73] = "ksat in component parameters (dimensionless)"
    legend_constants[77] = "xgamma in component parameters (dimensionless)"
    ...
    legend_constants[74] = "ena in component parameters (mV)"
    legend_constants[75] = "ek in component parameters (mV)"
    legend_constants[76] = "ecl in component parameters (mV)"
    ...
    legend_constants[20] = "conversion in component Ca_dependent_Force (nM_to_mM)"
    ...
    legend_algebraic[22] = "ical in component I_CaL (uA_per_cm2)"
    legend_algebraic[26] = "icat in component I_CaT (uA_per_cm2)"
    ...
    legend_algebraic[37] = "iBKab in component I_BKab (uA_per_cm2)"
    legend_algebraic[33] = "iBKa in component I_BKa (uA_per_cm2)"
    legend_algebraic[29] = "ikv43 in component I_Kv43 (uA_per_cm2)"
    ...
    legend_constants[21] = "conversion in component I_BKa (mM_to_M)"
    ...
    legend_constants[22] = "conversion in component I_BKab (mM_to_M)"
    ...
    legend_algebraic[40] = "insna in component I_NSNa (uA_per_cm2)"
    legend_algebraic[41] = "insk in component I_NSK (uA_per_cm2)"
    ...
    legend_constants[24] = "jnaca_sign in component J_NaCa (dimensionless)"
...
def init_consts():
    ...
    constants[23] = 1e-8
    constants[24] = -1
    constants[25] = constants[6] / constants[8]
    constants[26] = constants[5] / constants[7]
    constants[27] = 2.50000
    constants[28] = 0.500000
    constants[29] = 1.00000
    constants[30] = 1.00000
    constants[31] = 45.0000
    constants[32] = 0.00100000
    constants[33] = 42.0000
    constants[34] = 1.30000
    constants[35] = 0.900000
    constants[36] = 0.890000
    constants[37] = 1.00000
    constants[38] = 0.500000
    constants[39] = 1.00000
    constants[40] = 1.19000
    constants[41] = 1.60000
    constants[42] = 1.00000
    constants[43] = 0.350000
    ...
    constants[56] = 140.000
    constants[57] = 4.00000
    constants[58] = 0.108043 + 0.903902 / (
        1.00000 + np.power(constants[28] / 0.281007, 1.29834)
    )
    constants[59] = ((1.00000 / 0.000525000) * 0.0300000) / (
        1.00000 + np.power(150.000 / (constants[27] + constants[23]), 2.00000)
    )
    constants[60] = 46.0000
    constants[61] = 6.00000
    constants[62] = 130.000
    constants[63] = ((1.00000 / 0.0123000) * 0.0300000) / (
        1.00000 + np.power(150.000 / (constants[61] + constants[23]), 2.00000)
    )
    ...
    constants[71] = 308.000
    constants[72] = 3.50000e-06
    constants[73] = 0.270000
    constants[74] = ((constants[69] * constants[71]) / constants[70]) * np.log(
        constants[62] / constants[57]
    )
    constants[75] = ((constants[69] * constants[71]) / constants[70]) * np.log(
        constants[61] / constants[56]
    )
    constants[76] = ((constants[69] * constants[71]) / constants[70]) * np.log(
        constants[60] / constants[64]
    )
    constants[77] = 0.350000
...
def compute_rates(voi, states, constants):
    ...
    algebraic[1] = 1.00000 / (
        1.00000 +
        np.power((constants[54] * constants[20]) / states[1], constants[55])
    )
    algebraic[7] = 4000.00 * (
        0.234845
        + (1.00000 - 0.234845)
    ...
    algebraic[6] = (states[0] * constants[70]) / \
        (constants[69] * constants[71])
    ...
    algebraic[18] = 1.00000 / \
        (1.00000 + np.power(states[1] / constants[32], 4.00000))
    algebraic[22] = (
        ((constants[26] * constants[11]) / constants[25])
        * algebraic[18]
        * algebraic[20]
        * algebraic[20]
        * (0.800000 * algebraic[21] + 0.200000 * states[4])
        * (states[0] - constants[31])
    )
    ...
    algebraic[26] = (
        ...
        * algebraic[24]
        * algebraic[25]
        * (states[0] - constants[33])
    )
    algebraic[27] = algebraic[22] + algebraic[26]
    algebraic[12] = ((constants[69] * constants[71]) / constants[70]) * np.log(
        (
            constants[34] * constants[61]
            + constants[35] * constants[62]
            + (4.00000 * constants[36] * constants[27])
            / (1.00000 + np.exp(algebraic[6]))
        )
        / (
            constants[34] * constants[56]
            + constants[35] * constants[57]
            + (4.00000 * constants[36] * states[1]) /
            (1.00000 + np.exp(algebraic[6]))
        )
    )
    algebraic[42] = (
    ...
    algebraic[34] = -0.681249 / (
        1.00000 + np.power((states[1] * constants[22] -
                           0.218988) / 0.428335, 2.00000)
    ) + 1.40001 / (
        1.00000 +
        np.power((states[1] * constants[22] + 228.710) / 684.946, 2.00000)
    )
    algebraic[35] = (
        8540.23
        / (
            1.00000
            + np.power((states[1] * constants[22] +
    ...
    algebraic[36] = 1.00000 / (
        1.00000
        + np.exp(
            (-algebraic[34] * constants[70] * (states[0] - algebraic[35]))
            / (constants[69] * constants[71])
        )
    )
    algebraic[37] = (
        ...
        * constants[17]
        * algebraic[36]
        * (states[0] - constants[75])
    )
    algebraic[30] = -0.749234 / (
        1.00000 + np.power((states[1] * constants[21] -
                           0.0630535) / 0.161942, 2.00000)
    ) + 8.38384 / (
        1.00000 +
        np.power((states[1] * constants[21] + 1538.29) / 739.057, 2.00000)
    )
    algebraic[31] = (
        5011.47
        / (
            1.00000
            + np.power((states[1] * constants[21] +
    ...
    algebraic[32] = 1.00000 / (
        1.00000
        + np.exp(
            (-algebraic[30] * constants[70] * (states[0] - algebraic[31]))
            / (constants[69] * constants[71])
        )
    )
    algebraic[33] = (
    ...
    algebraic[16] = (
        ((constants[25] * constants[10]) / constants[26])
        * algebraic[14]
        * algebraic[14]
        * algebraic[14]
        * states[3]
    ...
    algebraic[46] = np.exp((constants[77] - 1.00000) * algebraic[6])
    algebraic[48] = np.exp(constants[77] * algebraic[6])
    algebraic[50] = (np.power(constants[57], 3.00000)) * constants[27] * algebraic[
        48
    ] - (np.power(constants[62], 3.00000)) * states[1] * algebraic[46]
    algebraic[51] = 1.00000 + constants[73] * algebraic[46]
    algebraic[52] = (
        constants[52] * (np.power(constants[57], 3.00000))
    ...
    algebraic[53] = (
        constants[27] * (np.power(constants[57], 3.00000))
        + (np.power(constants[62], 3.00000)) * states[1]
        + (np.power(constants[62], 3.00000))
        * constants[50]
        * (1.00000 + np.power(constants[57] / constants[49], 3.00000))
    )
    algebraic[54] = (constants[24] * constants[72] * algebraic[49] * algebraic[50]) / (
        algebraic[51] * (algebraic[52] + algebraic[53])
    )
    algebraic[55] = constants[44] / (
...
def compute_algebraic(constants, states, voi):
    ...
    algebraic[47] = algebraic[44] * constants[9]
    algebraic[56] = algebraic[54] * constants[9]
    algebraic[58] = algebraic[55] * constants[9]
    return algebraic
