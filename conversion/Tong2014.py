...
def create_legends():
    ...
    legend_algebraic[0] = "Ist in component interface (uA_per_cm2)"
    ...
    legend_constants[3] = "stim_current in component interface (uA_per_cm2)"
    legend_algebraic[104] = "I_tot in component membrane_potential (uA_per_cm2)"
    legend_algebraic[86] = "I_Ca_tot in component membrane_potential (uA_per_cm2)"
    legend_states[0] = "v in component membrane_potential (mV)"
    legend_constants[73] = "Cm in component parameters (uF_per_cm2)"
    legend_algebraic[63] = "ina in component I_Na (uA_per_cm2)"
    legend_algebraic[70] = "ical in component I_CaL (uA_per_cm2)"
    legend_algebraic[72] = "icat in component I_CaT (uA_per_cm2)"
    legend_algebraic[73] = "ib in component I_b (uA_per_cm2)"
    legend_algebraic[74] = "iherg in component I_HERG (uA_per_cm2)"
    legend_algebraic[75] = "ikcnq1 in component I_KCNQ1 (uA_per_cm2)"
    legend_algebraic[76] = "ikcnq4 in component I_KCNQ4 (uA_per_cm2)"
    legend_algebraic[77] = "ikcnq5 in component I_KCNQ5 (uA_per_cm2)"
    legend_algebraic[78] = "ik1 in component I_K1 (uA_per_cm2)"
    legend_algebraic[79] = "ik2 in component I_K2 (uA_per_cm2)"
    legend_algebraic[80] = "ika in component I_Ka (uA_per_cm2)"
    legend_algebraic[81] = "iBKa in component I_BKa (uA_per_cm2)"
    legend_algebraic[82] = "iBKab in component I_BKab (uA_per_cm2)"
    legend_algebraic[83] = "ih in component I_h (uA_per_cm2)"
    legend_algebraic[84] = "icl in component I_Cl (uA_per_cm2)"
    legend_algebraic[88] = "insna in component I_ns (uA_per_cm2)"
    legend_algebraic[85] = "insca in component I_ns (uA_per_cm2)"
    legend_algebraic[90] = "insk in component I_ns (uA_per_cm2)"
    legend_algebraic[92] = "inak in component I_NaK (uA_per_cm2)"
    legend_algebraic[101] = "inaca in component I_NaCa (uA_per_cm2)"
    ...
    legend_constants[16] = "gna in component parameters (mS_per_cm2)"
    legend_constants[17] = "gcal in component parameters (mS_per_cm2)"
    legend_constants[18] = "ecal in component parameters (mV)"
    legend_constants[19] = "kmca in component parameters (mM)"
    legend_constants[20] = "gcat in component parameters (mS_per_cm2)"
    legend_constants[21] = "ecat in component parameters (mV)"
    legend_constants[22] = "gkca in component parameters (mS_per_cm2)"
    legend_constants[23] = "gb in component parameters (mS_per_cm2)"
    legend_constants[24] = "gk1 in component parameters (mS_per_cm2)"
    legend_constants[25] = "gk2 in component parameters (mS_per_cm2)"
    ...
    legend_constants[28] = "gka in component parameters (mS_per_cm2)"
    legend_constants[29] = "gkq1 in component parameters (mS_per_cm2)"
    legend_constants[30] = "gkq4 in component parameters (mS_per_cm2)"
    legend_constants[31] = "gkq5 in component parameters (mS_per_cm2)"
    legend_constants[32] = "gherg in component parameters (mS_per_cm2)"
    legend_constants[33] = "gcl in component parameters (mS_per_cm2)"
    legend_constants[34] = "gh in component parameters (mS_per_cm2)"
    legend_constants[35] = "gns in component parameters (mS_per_cm2)"
    ...
    legend_constants[75] = "ginak in component parameters (uA_per_cm2)"
...
def compute_rates(voi, states, constants):
    ...
    rates[0] = -(algebraic[104] + algebraic[0]) / constants[73]
