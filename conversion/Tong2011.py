...
def create_legends():
    ...
    legend_constants[62] = "buff in component parameters (dimensionnp.less)"
    legend_constants[63] = "AV in component parameters (cm2_per_uL)"
    legend_constants[64] = "zca in component parameters (dimensionnp.less)"
    ...
    legend_constants[32] = "PnsK in component parameters (dimensionnp.less)"
    legend_constants[33] = "PnsNa in component parameters (dimensionnp.less)"
    legend_constants[34] = "PnsCa in component parameters (dimensionnp.less)"
    legend_constants[35] = "PnsCs in component parameters (dimensionnp.less)"
    legend_constants[36] = "gnsCa in component parameters (dimensionnp.less)"
    legend_constants[37] = "gnsNa in component parameters (dimensionnp.less)"
    legend_constants[38] = "gnsK in component parameters (dimensionnp.less)"
    legend_constants[39] = "gnsCs in component parameters (dimensionnp.less)"
    ...
    legend_constants[70] = "PK in component parameters (dimensionnp.less)"
    legend_constants[75] = "PNa in component parameters (dimensionnp.less)"
    legend_constants[40] = "Jpmca in component parameters (mM_per_msec)"
    legend_constants[41] = "Kmpmca in component parameters (mM)"
    legend_constants[42] = "npmca in component parameters (dimensionnp.less)"
    legend_constants[78] = "Jnaca in component parameters (mM_per_msec)"
    legend_constants[43] = "Kmallo in component parameters (mM)"
    legend_constants[44] = "nallo in component parameters (dimensionnp.less)"
    legend_constants[79] = "ksat in component parameters (dimensionnp.less)"
    legend_constants[80] = "xgamma in component parameters (dimensionnp.less)"
    ...
    legend_constants[51] = "Fn in component parameters (dimensionnp.less)"
    legend_algebraic[18] = "vFRT in component parameters (dimensionnp.less)"
    ...
    legend_algebraic[47] = "fca in component I_CaL (dimensionnp.less)"
    ...
    legend_algebraic[9] = "qss in component I_K1 (dimensionnp.less)"
    legend_algebraic[10] = "rss in component I_K1 (dimensionnp.less)"
    ...
    legend_states[10] = "q in component I_K1 (dimensionnp.less)"
    legend_states[11] = "r1 in component I_K1 (dimensionnp.less)"
    legend_states[12] = "r2 in component I_K1 (dimensionnp.less)"
    legend_algebraic[11] = "pss in component I_K2 (dimensionnp.less)"
    legend_algebraic[12] = "kss in component I_K2 (dimensionnp.less)"
    ...
    legend_states[13] = "p in component I_K2 (dimensionnp.less)"
    legend_states[14] = "k1 in component I_K2 (dimensionnp.less)"
    legend_states[15] = "k2 in component I_K2 (dimensionnp.less)"
    legend_algebraic[13] = "sss in component I_Ka (dimensionnp.less)"
    legend_algebraic[14] = "xss in component I_Ka (dimensionnp.less)"
    legend_algebraic[32] = "stc in component I_Ka (msec)"
    legend_algebraic[33] = "xtc in component I_Ka (msec)"
    legend_states[16] = "s in component I_Ka (dimensionnp.less)"
    legend_states[17] = "x in component I_Ka (dimensionnp.less)"
    legend_algebraic[15] = "xass_z in component I_BKa (dimensionnp.less)"
    legend_algebraic[34] = "xass_vh in component I_BKa (mV)"
    legend_constants[6] = "conversion in component I_BKa (mM_to_M)"
    legend_algebraic[38] = "xass in component I_BKa (dimensionnp.less)"
    legend_algebraic[43] = "xatc in component I_BKa (msec)"
    legend_states[18] = "xa in component I_BKa (dimensionnp.less)"
    legend_algebraic[16] = "xabss_z in component I_BKab (dimensionnp.less)"
    legend_algebraic[35] = "xabss_vh in component I_BKab (mV)"
    legend_constants[7] = "conversion in component I_BKab (mM_to_M)"
    legend_algebraic[39] = "xabss in component I_BKab (dimensionnp.less)"
    legend_algebraic[44] = "xabtc in component I_BKab (msec)"
    legend_states[19] = "xab in component I_BKab (dimensionnp.less)"
    legend_algebraic[17] = "yss in component I_h (dimensionnp.less)"
    ...
    legend_states[20] = "y in component I_h (dimensionnp.less)"
    legend_algebraic[48] = "css in component I_Cl (dimensionnp.less)"
    legend_algebraic[50] = "ctc in component I_Cl (msec)"
    legend_algebraic[41] = "K1cl in component I_Cl (mM)"
    legend_algebraic[46] = "K2cl in component I_Cl (dimensionnp.less)"
    legend_states[21] = "c in component I_Cl (dimensionnp.less)"
    legend_constants[54] = "fmg in component I_ns (dimensionnp.less)"
    legend_constants[61] = "gs_nao in component I_ns (dimensionnp.less)"
    legend_constants[55] = "gs_cao in component I_ns (dimensionnp.less)"
    legend_constants[59] = "gs_ko in component I_ns (dimensionnp.less)"
    legend_constants[8] = "tinyamount in component I_ns (mM)"
    legend_algebraic[66] = "fnak in component I_NaK (dimensionnp.less)"
    legend_constants[81] = "knak in component I_NaK (dimensionnp.less)"
    legend_constants[82] = "nnak in component I_NaK (dimensionnp.less)"
    legend_constants[9] = "inaca_sign in component I_NaCa (dimensionnp.less)"
    legend_algebraic[68] = "f1naca in component J_NaCa (dimensionnp.less)"
    legend_algebraic[69] = "f2naca in component J_NaCa (dimensionnp.less)"
    legend_algebraic[70] = "fallo in component J_NaCa (dimensionnp.less)"
    legend_algebraic[71] = "naca_Eup in component J_NaCa (mM4)"
    legend_algebraic[72] = "naca_Ed1 in component J_NaCa (dimensionnp.less)"
    ...
    legend_rates[10] = "d/dt q in component I_K1 (dimensionnp.less)"
    legend_rates[11] = "d/dt r1 in component I_K1 (dimensionnp.less)"
    legend_rates[12] = "d/dt r2 in component I_K1 (dimensionnp.less)"
    legend_rates[13] = "d/dt p in component I_K2 (dimensionnp.less)"
    legend_rates[14] = "d/dt k1 in component I_K2 (dimensionnp.less)"
    legend_rates[15] = "d/dt k2 in component I_K2 (dimensionnp.less)"
    legend_rates[16] = "d/dt s in component I_Ka (dimensionnp.less)"
    legend_rates[17] = "d/dt x in component I_Ka (dimensionnp.less)"
    legend_rates[18] = "d/dt xa in component I_BKa (dimensionnp.less)"
    legend_rates[19] = "d/dt xab in component I_BKab (dimensionnp.less)"
    legend_rates[20] = "d/dt y in component I_h (dimensionnp.less)"
    legend_rates[21] = "d/dt c in component I_Cl (dimensionnp.less)"
...
def compute_rates(voi, states, constants):
    ...
    algebraic[1] = 1.00000 / (
        1.00000 +
        np.power((constants[50] * constants[5]) / states[1], constants[51])
    )
    algebraic[19] = 4000.00 * (
        ...
        / (
            1.00000
            + np.power(states[1] / (constants[50] *
                       constants[5]), constants[51])
        )
    )
    ...
    algebraic[18] = (states[0] * constants[66]) / \
        (constants[65] * constants[68])
    ...
    algebraic[56] = (
        ...
        states[18] * (states[0] - constants[72])
    )
    algebraic[57] = (
        constants[22] * constants[27] *
        states[19] * (states[0] - constants[72])
    )
    ...
    algebraic[67] = constants[69] * \
        constants[81] * constants[82] * algebraic[66]
