...
def create_legends():
    ...
    legend_algebraic[79] = "I_tot in component membrane_potential (uA_per_cm2)"
    legend_algebraic[61] = "I_Ca_tot in component membrane_potential (uA_per_cm2)"
    legend_states[0] = "v in component membrane_potential (mV)"
    legend_constants[67] = "Cm in component parameters (uF_per_cm2)"
    legend_algebraic[42] = "ina in component I_Na (uA_per_cm2)"
    legend_algebraic[49] = "ical in component I_CaL (uA_per_cm2)"
    legend_algebraic[51] = "icat in component I_CaT (uA_per_cm2)"
    legend_algebraic[52] = "ib in component I_b (uA_per_cm2)"
    legend_algebraic[53] = "ik1 in component I_K1 (uA_per_cm2)"
    legend_algebraic[54] = "ik2 in component I_K2 (uA_per_cm2)"
    legend_algebraic[55] = "ika in component I_Ka (uA_per_cm2)"
    legend_algebraic[56] = "iBKa in component I_BKa (uA_per_cm2)"
    legend_algebraic[57] = "iBKab in component I_BKab (uA_per_cm2)"
    legend_algebraic[58] = "ih in component I_h (uA_per_cm2)"
    legend_algebraic[59] = "icl in component I_Cl (uA_per_cm2)"
    legend_algebraic[63] = "insna in component I_ns (uA_per_cm2)"
    legend_algebraic[60] = "insca in component I_ns (uA_per_cm2)"
    legend_algebraic[65] = "insk in component I_ns (uA_per_cm2)"
    legend_algebraic[67] = "inak in component I_NaK (uA_per_cm2)"
    legend_algebraic[76] = "inaca in component I_NaCa (uA_per_cm2)"
    ...
    legend_constants[29] = "gcl in component parameters (mS_per_cm2)"
    legend_constants[30] = "gh in component parameters (mS_per_cm2)"
    legend_constants[31] = "gns in component parameters (mS_per_cm2)"
    ...
    legend_constants[69] = "ginak in component parameters (uA_per_cm2)"
